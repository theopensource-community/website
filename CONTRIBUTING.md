<!-- omit in toc -->
# Contributing to TheOpenSource.community
...
- Mention the project at local meetups or developer events, and tell your friends/colleagues
...
> If you want to ask a question, we assume that you have read the available [Documentation](https://github.com/theopensource-community/website/blob/main/README.md).

Before you ask a question, it is best to search for existing [Issues](https://github.com/theopensource-community/website/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/theopensource-community/website/issues/new).
...
- Open an [Issue](https://github.com/theopensource-community/website/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/theopensource-community/website/issues).
